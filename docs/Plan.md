...
- JUnit Jupiter, инструмент тестирования, более привычен нежели JUnit4 или TestNG;
...
1. Написание тестов до 27 апреля 2023;
2. Предоставление отчетов до 1 мая 2023:
